 ...
 */
    ...
    // let userShouldTipAmount = alert("Your total tip amount is " + userBillAmount * (userTipPercentage/100));
    // console.log(userShouldTipAmount);

const userTipPercentage = (parseFloat(prompt("How much would you like to tip asa  whole percentage number?")))/100;
