...
analyzeColor(prompt("Input a color, please"));
...
let totalAmount = parseFloat(prompt("What was your total bill?"));
...
// let totalAmount = prompt("What was your total bill?");

// const discountedBill = alert(calculateTotal(luckyNumber, totalAmount));
// alert(`Your lucky number is ${luckyNumber}\n\nThe total amount before discount is $${totalAmount}\n\nThe total amount of after discount is $${discountedBill}`);
